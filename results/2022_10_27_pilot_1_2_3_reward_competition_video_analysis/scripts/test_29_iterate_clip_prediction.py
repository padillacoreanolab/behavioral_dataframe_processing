...
model_fullpath = "/nancy/projects/sleap_pose_tracking/results/2022_10_10_pilot_1_2_3_reward_competition_c57/proc/round_4_test_29/models/baseline_medium_rf.bottomup"

cs_presentation_frame_df = pd.read_csv("/nancy/user/riwata/projects/behavioral_dataframe_processing/results/2022_10_27_pilot_1_2_3_reward_competition_video_analysis/proc/10-03-22_Test_29_3-2v3-3.mp4.cs_presentation_frame_numbers.csv")
